...
public class GosConfigCountdownActivity extends GosConfigModuleBaseActivity {
	...
	Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case SUCCESSFUL:
				Toast.makeText(GosConfigCountdownActivity.this, R.string.configuration_successful, 2000)
						.show();
				finish();
				break;

			case FAILED:
				Toast.makeText(GosConfigCountdownActivity.this,  msg.obj.toString(), 2000)
						.show();
